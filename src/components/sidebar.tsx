...
import { Radar, TrendingUp, Calculator, Car } from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-surface border-r border-border-subtle flex flex-col z-40">
      {/* Logo */}
